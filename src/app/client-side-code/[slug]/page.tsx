...
export default  async function ProductPage({params}:param) {
...
const productDetail:product = await res.json() 
    ...
    <div>
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
            ...
            /> */}
              {productDetail?.image ? (
                <div className="mx-auto  lg:w-1/2 w-full relative h-[370px] xl:h-[450px] rounded-md">
                  <Image
                    src={productDetail?.image}
                    fill
